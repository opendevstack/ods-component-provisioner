...
CC_CLIENT_SRC_FROM="./generated-sources/openapi-client-component_catalog/src/%s/java/org/opendevstack/component_provisioner/client/component_catalog/v1"
CC_CLIENT_SRC_TO="../../src/%s/java/org/opendevstack/component_provisioner/client/component_catalog/v1"
