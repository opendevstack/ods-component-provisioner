...
import com.boehringer.componentprovisioner.client.awx.v2.model.ApiProjectUpdatesEventsList200Response;
...
@Component("com.boehringer.componentprovisioner.client.awx.v2.api.ProjectUpdateEventsApi")
public class ProjectUpdateEventsApi extends BaseApi {

    public ProjectUpdateEventsApi() {
        super(new ApiClient());
    }

    @Autowired
    public ProjectUpdateEventsApi(ApiClient apiClient) {
        super(apiClient);
    }
     ...
     * @return ApiProjectUpdatesEventsList200Response
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ApiProjectUpdatesEventsList200Response apiProjectUpdatesEventsList(String version, String id, String search, Integer page, Integer pageSize) throws RestClientException {
        return apiProjectUpdatesEventsListWithHttpInfo(version, id, search, page, pageSize).getBody();
    }
     ...
     * @param page A page number within the paginated result set. (optional)
     * @param pageSize Number of results to return per page. (optional)
     * @return ResponseEntity&lt;ApiProjectUpdatesEventsList200Response&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<ApiProjectUpdatesEventsList200Response> apiProjectUpdatesEventsListWithHttpInfo(String version, String id, String search, Integer page, Integer pageSize) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'version' is set
        if (version == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'version' when calling apiProjectUpdatesEventsList");
        }
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling apiProjectUpdatesEventsList");
        }
        ...
        ParameterizedTypeReference<ApiProjectUpdatesEventsList200Response> localReturnType = new ParameterizedTypeReference<ApiProjectUpdatesEventsList200Response>() {};
        return apiClient.invokeAPI("/api/v2/project_updates/{id}/events/", HttpMethod.GET, uriVariables, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
