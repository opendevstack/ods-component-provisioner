...
@ComponentScan(
        basePackages = {
                "com.boehringer.componentprovisioner.server.api",
                "com.boehringer.componentprovisioner.server.controllers",
                "com.boehringer.componentprovisioner.server.security",
                "com.boehringer.componentprovisioner.config",
                "com.boehringer.componentprovisioner.server.services",
                "com.boehringer.componentprovisioner.client.awx.v2"
        },
        nameGenerator = FullyQualifiedAnnotationBeanNameGenerator.class
)
