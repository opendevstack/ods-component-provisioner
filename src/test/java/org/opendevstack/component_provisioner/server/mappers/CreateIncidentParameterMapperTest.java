...
class CreateIncidentParameterMapperTest {
    ...
    @Test
    void givenNullValues_whenGetFirstValueIsCalled_thenReturnsNull() {
        // given
        List<String> values = null;

        // when
        Object result = mapper.getFirstValue(values);
    ...
    @Test
    void givenEmptyValues_whenGetFirstValueIsCalled_thenReturnsNull() {
        // given
    ...
    @Test
    void givenValues_whenGetFirstValueIsCalled_thenReturnsFirstElement() {
        // given
